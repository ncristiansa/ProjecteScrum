...
--
-- Host: localhost    Database: ScrumDB3_2
-- ------------------------------------------------------
...
INSERT INTO `Groups` VALUES (1,'A',3),(3,'C',3),(2,'B',4),(2,'B',3);
...
INSERT INTO `Homework` VALUES (1,'Configurarem les caracteristiques dels personatges a l\'arxiu de configuracio config.txt',1,1,1,1),(2,'Les caracteristiques son finites i hi haura una per linia a l\'arxiu de conf. Per exemple:',1,2,1,1),(4,'Les caracteristiques (ros, moreno, dona, ... ) i els noms d\'arxiu no poden contenir espais (en tot cas, poseu un underscore \"_\").',3,5,1,1),(5,'Crear un boto amb el text: \"Fes la pregunta\" que en clicar-lo detecti quin combo box te la pregunta a realitzar y consulti en els atributs de la carta seleccionada pel servidor la respota y la imprimeixi per pantalla',3,13,2,1),(6,'La forma del tauler ha de ser rectangular, en vista vertical. ',1,14,2,1),(7,'En cas de que el boto \"Fes la pregunta\" generi un error per que hi ha mes d\'un combo box \"activat\" a mes a mes de mostrar el missatge d\'error ha de \"resetejar\" tots el combo box',1,16,2,1),(8,'Crear estructura HTML',2,1,3,2),(9,'Generar un formulario con DOM para que el usuario pueda registrarse y guardar su partida.',2,1,4,2);
...
INSERT INTO `Sprints` VALUES (1,1,27,'2017-12-12','2018-12-12',1,0),(2,1,24,'2018-12-12','2019-01-01',2,1),(3,2,24,'2018-12-12','2019-01-01',2,1),(4,2,27,'2017-12-12','2018-12-12',1,0);
...
-- Dump completed on 2018-12-18 12:00:27
