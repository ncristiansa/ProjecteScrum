...
--
-- Servidor: localhost
-- Tiempo de generación: 16-12-2018 a las 21:43:28
...
(1, 'Configurarem les característiques dels personatges a l''arxiu de configuració config.txt', 1, 1, 1, 1),
(2, 'Les característiques són finites i hi haurà una per línia a l''arxiu de conf. Per exemple:', 1, 2, 1, 1),
(4, 'Les característiques (ros, moreno, dona, ... ) i els noms d''arxiu no poden contenir espais (en tot cas, poseu un underscore "_").', 3, 5, 1, 1),
(5, 'Crear un botó amb el text: "Fes la pregunta" que en clicar-lo detecti quin combo box té la pregunta a realitzar y consulti en els atributs de la carta seleccionada pel servidor la respota y la imprimeixi per pantalla', 3, 13, 2, 1),
(6, 'La forma del tauler ha de ser rectangular, en vista vertical. ', 1, 14, 2, 1),
(7, 'En cas de que el botó "Fes la pregunta" generi un error per que hi ha més d''un combo box "activat" a més a més de mostrar el missatge d''error ha de "resetejar" tots el combo box', 1, 16, 2, 1);
